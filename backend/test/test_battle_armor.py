"""Tests for Battle Armor / Shell Armor abilities.

Battle Armor / Shell Armor: prevent critical hits.

Test case:
Verify that a Bulbasaur with Merciless under poison still doesn't get a critical hit
against a Bulbasaur with Battle Armor (because Battle Armor blocks crits):
0 SpA Bulbasaur Solar Beam vs. 0 HP / 0 SpD Bulbasaur with Battle Armor: 16-20 (13.3 - 16.6%)
...
def test_battle_armor_blocks_crit():
    """Merciless Bulbasaur vs. poisoned Bulbasaur with Battle Armor (crit should be blocked)."""
...
def test_shell_armor_blocks_crit():
    """Merciless Bulbasaur vs. poisoned Bulbasaur with Shell Armor (crit should be blocked)."""
    attacker = get_pokemon_stats(
        species="bulbasaur",
        level=50,
        evs={"hp": 0, "attack": 0, "defense": 0, "special-attack": 0, "special-defense": 0, "speed": 0},
...
if __name__ == "__main__":
    test_battle_armor_blocks_crit()
    test_shell_armor_blocks_crit()
    print("All Battle Armor / Shell Armor tests passed!")
