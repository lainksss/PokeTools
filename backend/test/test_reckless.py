"""Test Reckless (Staraptor) with Double-Edge.

Case: 0 Atk Reckless Staraptor Double-Edge vs. 0 HP / 0 Def Bulbasaur: 165-195
Expected damage distribution (random 85-100):
(165, 166, 169, 171, 172, 175, 177, 178, 180, 183, 184, 186, 189, 190, 192, 195)
"""
import sys
import json
...
def test_reckless_staraptor_double_edge():
    # Attacker: Staraptor, level 50, 0 EVs Attack (neutral nature)
    ...
    # Double-Edge: high BP 120 with recoil -> mark recoil True so Reckless triggers
    move = {"name": "double-edge", "power": 120, "type": "normal", "damage_class": "physical", "recoil": True}
    ...
    expected = (165, 166, 169, 171, 172, 175, 177, 178, 180, 183, 184, 186, 189, 190, 192, 195)
