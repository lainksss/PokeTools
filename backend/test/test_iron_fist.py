"""Test Iron Fist (Golurk) with Shadow Punch.

Case: 0 Atk Iron Fist Golurk Shadow Punch vs. 0 HP / 0 Def Bulbasaur: 85-102
...
def test_iron_fist_golurk_shadow_punch():
    # Attacker: Golurk, level 50, 0 EVs Attack (neutral nature)
    attacker = get_pokemon_stats(
        species="golurk",
        level=50,
        evs={"hp": 0, "attack": 0, "defense": 0, "special-attack": 0, "special-defense": 0, "speed": 0},
    )
    attacker["ability"] = "iron-fist"
    ...
    # Shadow Punch is a punching physical move; rely on flags enrichment to set is_punch
    move = {"name": "shadow-punch", "power": 60, "type": "ghost", "damage_class": "physical"}
    ...
    expected = (85, 87, 88, 88, 90, 91, 91, 93, 94, 94, 96, 97, 97, 99, 100, 102)
