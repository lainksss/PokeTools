"""Test Strong Jaw (Bruxish) with Psychic Fangs.

Case: 0 Atk Strong Jaw Bruxish Psychic Fangs vs. 0 HP / 0 Def Bulbasaur: 260-308
...
def test_strong_jaw_bruxish_psychic_fangs():
    # Attacker: Bruxish, level 50, 0 EVs Attack (neutral nature)
    ...
    # Psychic Fangs is a biting, contact, physical move with base power 85
    ...
    expected = (260, 264, 266, 270, 272, 276, 278, 282, 284, 288, 290, 294, 296, 300, 302, 308)
