"""Test Tough Claws (Perrserker) with Metal Claw.

Case: 0 Atk Tough Claws Perrserker Metal Claw vs. 0 HP / 0 Def Bulbasaur: 69-82
...
def test_tough_claws_perrserker_metal_claw():
    # Attacker: Perrserker, level 50, 0 EVs Attack (neutral nature)
    ...
    move = {"name": "metal-claw", "power": 50, "type": "steel", "damage_class": "physical"}
    ...
    expected = (69, 70, 70, 72, 72, 73, 75, 75, 76, 76, 78, 78, 79, 79, 81, 82)
